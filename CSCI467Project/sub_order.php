...
<body>
    ...
    <div class="container">
      <div class="navbar">
          ...
          <img src="C:\Users\ethan\Downloads\autoparts.png" class="menu-icon" onclick="menutoggle()">
      </div>
    </div>
    </div>
	<title>Order</title>
...
<form action="sub_order.php" method="POST"> Name:

        <input type="text" name="fullname"> Email:
	...
	<input type="text" name="State"> <br> Zip Code:

	<input type="text" name="ZipCode"> <br> Card Number:

	<input type="text" name="CardNumber"> <br> Expiration Date:
...
<?php
	...
	echo("Your order has been placed succesfully, thank you!");
	}
	endif;
?>
</body>
