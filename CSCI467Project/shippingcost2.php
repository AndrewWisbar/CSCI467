...
<body>
    ...
    <div class="container">
      <div class="navbar">
          ...
          <img src="C:\Users\ethan\Downloads\autoparts.jpg" class="menu-icon" onclick="menutoggle()">
      </div>
      </div>
      </div>


 <form action="http://students.cs.niu.edu/~z1826490/shippingcost2.php" method="post">
   <style >
     .center{
       margin-left: auto;
       margin-right: auto;
