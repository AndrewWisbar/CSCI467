...
This script holds a function used at multiple points in the website
The script takes in product info, and uses it to generate a product "card"
that then gets displayed to the user.
*/
